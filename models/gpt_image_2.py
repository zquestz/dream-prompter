...
"""
GPT Image 2 model implementation
OpenAI's next generation image generation model
...
class GPTImage2Model(BaseModel):
    """OpenAI's GPT Image 2 model implementation for Replicate"""

    @property
    def capabilities(self) -> ModelCapability:
        """GPT Image 2 supports generation only"""
    ...
    def description(self) -> str:
        """Model description"""
        return _("OpenAI's next generation image generation model")

    @property
    def display_name(self) -> str:
        """Human-readable model name"""
        return _("GPT Image 2")
    ...
    def get_parameter_definitions(self) -> List[ParameterDefinition]:
        """Get list of configurable parameters for GPT Image 2"""
        return [
            ParameterDefinition(
                name="openai_api_key",
...
gpt_image_2 = GPTImage2Model()
register_model(gpt_image_2)
