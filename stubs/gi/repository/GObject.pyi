...
class GError:
    ...
    def new_literal(domain, message, code): ...  # type: ignore[misc]
...
class GParamSpec:
    ...
    ref_count: int = ...
    param_id: int = ...
    def blurb(fget): ...  # type: ignore[misc]
    ...
    def nick(fget): ...  # type: ignore[misc]
...
class IOChannel(GBoxed):
    ...
    def read_chars(self) -> Tuple[GLib.IOStatus, bytes, int]: ...
    def read_line(self) -> Tuple[GLib.IOStatus, str, int, int]: ...
    def read_line_string(
        self, buffer: GLib.String, terminator_pos: Optional[int] = None
    ) -> GLib.IOStatus: ...
    ...
    def set_encoding(self, encoding: Optional[str] = None) -> GLib.IOStatus: ...
...
class TypePluginClass(GPointer):
    ...
    complete_type_info: Callable[[TypePlugin, Type, TypeInfo, TypeValueTable], None] = (
        ...
    )
    complete_interface_info: Callable[[TypePlugin, Type, Type, InterfaceInfo], None] = (
        ...
    )
...
class TypeValueTable(GPointer):
    ...
    collect_format: str = ...
    collect_value: Callable[[Any, Sequence[TypeCValue], int], Optional[str]] = ...
    lcopy_format: str = ...
    lcopy_value: Callable[[Any, Sequence[TypeCValue], int], Optional[str]] = ...
...
class Value(GBoxed):
    ...
    def steal_string(self) -> Optional[str]: ...
